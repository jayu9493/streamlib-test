...
#from streamlit_webrtc import AudioProcessorBase,RTCConfiguration,VideoProcessorBase,WebRtcMode,webrtc_streamereb
...
def app_video_filters():
    ...
    st.markdown(
        "This demo is inspired from https://share.streamlit.io/whitphx/streamlit-webrtc-example/main/app.py"
...
papa_image = face_recognition.load_image_file("dad.jpg")
papa_face_encoding = face_recognition.face_encodings(papa_image)[0]

meet_image = face_recognition.load_image_file("meet.jpg")
